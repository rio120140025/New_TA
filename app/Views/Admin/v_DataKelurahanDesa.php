			...
			<div>
				...
				<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= site_url('datakelurahandesa/' . $current_page); ?>">
								<iconify-icon icon="tabler:location-filled"></iconify-icon>
			...
			<div class="body-wrapper radial-gradient min-vh-100">
				<div class="container-fluid">
					<div class="container-fluid">
						<div class="card">
							<div class="card-body">
								<form method="post" action="<?= route_to('datakelurahandesa/' . $current_page); ?>">
									<div class="mb-3">
										<label for="search" class="form-label">Pencarian</label>
										<input type="text" class="form-control" name="search" id="search"
											aria-describedby="searchHelp">
										<div class="form-text">Masukkan kata kunci seperti nama provinsi atau nama
											kabupaten/kota atau nama kecamatan atau nama kelurahan/desa</div>
									</div>
						...
						<div class="card">
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="post"
													action="<?= site_url('DataKelurahanDesa/save_kelurahandesa/' . $current_page); ?>">
													<div class="mb-3">
													...
													<div class="mb-3">
														<h6 for="city_name" class="form-label">Kabupaten/Kota
														</h6>
													...
													<div class="mb-3">
														<h6 for="dis_name" class="form-label">Kecamatan
														</h6>
													...
													<div class="mb-3">
														<h6 for="subdis_name" class="form-label">Masukkan Nama
															Kelurahan/Desa</h6>
														<input type="text" class="form-control" name="subdis_name"
															id="subdis_name" required>
													</div>
									...
									<table class="table text-nowrap mb-0 align-middle">
										<thead class="text-dark fs-4">
											<tr>
												...
												<th class="border-bottom-0">
													<h6 class="fw-semibold mb-0">Kelurahan/Desa</h6>
												</th>
												<th class="border-bottom-0">
										...
										<tbody>
											...
											<?php foreach ($kelurahandesa as $row): ?>
												<tr>
													<td>
														<h6 class="fw-normal">
															<?= $number; ?>
													...
													<td>
														<a href="<?= site_url('DataKelurahanDesa/delete_kelurahandesa/' . $current_page . '/' . $row->subdis_id); ?>"
															class="text-danger">
							...
							<div class="pagination justify-content-center mb-4">
								<?php if ($total_data > 50): ?>
									...
									if ($current_page > 1) {
										echo '<a href="' . site_url("datakelurahandesa/" . ($current_page - 1)) . '" class="btn btn-primary"><</a>';
									}

									for ($i = $start_page; $i <= $max_pages; $i++) {
										echo '<a href="' . site_url("datakelurahandesa/" . $i) . '"';
										if ($i == $current_page) {
