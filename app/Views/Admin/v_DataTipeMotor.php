			...
			<div>
				...
				<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= site_url('datatipemotor/' . $current_page); ?>">
			...
			<div class="body-wrapper radial-gradient min-vh-100">
				<div class="container-fluid">
					<div class="container-fluid">
						<div class="card">
							<div class="card-body">
								<form method="post" action="<?= route_to('datatipemotor/' . $current_page); ?>">
									<div class="mb-3">
										<label for="search" class="form-label">Pencarian</label>
										<input type="text" class="form-control" name="search" id="search"
											aria-describedby="searchHelp">
										<div class="form-text">Masukkan kata kunci seperti tipe motor</div>
									</div>
						...
						<div class="card">
							<div class="card-body" id="tabelmotor">
								<div class="d-flex justify-content-between align-items-center mb-4">
									<h5 class="modal-title">Data Tipe Motor</h5>
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title">Tambah Data Tipe Motor</h5>
												<button type="button" class="btn-close" data-bs-dismiss="modal"
													aria-label="Close"></button>
											</div>
											<div class="modal-body">
												<form method="post"
													action="<?= site_url('DataTipeMotor/save_tipe_motor/' . $current_page); ?>">
													<div class="mb-3">
														<h6 for="tipe_motor" class="form-label"> Masukkan
															Tipe
															Motor</h6>
														<input type="text" class="form-control" name="tipe_motor"
															id="tipe_motor" required>
													</div>
										...
										<tbody>
											...
											<?php foreach ($motor as $row): ?>
												<tr>
													...
													<td>
														<a href="<?= site_url('DataTipeMotor/delete_tipe_motor/' . $current_page . '/' . $row->id_motor); ?>"
															class="text-danger">
							...
							<div class="pagination justify-content-center">
								<?php if ($total_data > 50): ?>
									...
									if ($current_page > 1) {
										echo '<a href="' . site_url("datatipemotor/" . ($current_page - 1)) . '" class="btn btn-primary"><</a>';
									}

									for ($i = $start_page; $i <= $max_pages; $i++) {
										echo '<a href="' . site_url("datatipemotor/" . $i) . '"';
										if ($i == $current_page) {
