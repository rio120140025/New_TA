                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url('UpdateLaporan/update_laporan') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?= $laporan['no_hp'] ?>" required>
                                </div>
                                <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jenis_kelamin" name="jenis_kelamin" required>
                                        <option value="" <?= ($laporan['jenis_kelamin'] == '') ? 'selected' : '' ?>>Pilih Jenis
                                            Kelamin</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="agama" name="agama" required>
                                        <option value="" <?= ($laporan['agama'] == '') ? 'selected' : '' ?>>Pilih Agama</option>
                                        <option value="Islam" <?= ($laporan['agama'] == 'Islam') ? 'selected' : '' ?>>
                                            Islam</option>
                                        <option value="Kristen" <?= ($laporan['agama'] == 'Kristen') ? 'selected' : '' ?>>Kristen
                                        </option>
                                        <option value="Katolik" <?= ($laporan['agama'] == 'Katolik') ? 'selected' : '' ?>>Katolik
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $laporan['alamat'] ?>" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="warna" name="warna" value="<?= $laporan['warna'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <h6 for="no_rangka" class="form-label">Nomor Rangka
                                    </h6>
                                    <input type="text" class="form-control" id="no_rangka" name="no_rangka"
                                        minlength="17" value="<?= $laporan['no_rangka'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <h6 for="no_mesin" class="form-label">Nomor Mesin
                                    </h6>
                                    <input type="text" class="form-control" id="no_mesin" name="no_mesin" value="<?= $laporan['no_mesin'] ?>" minlength="17"
                                        required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="kerugian" name="kerugian" value="<?= $laporan['kerugian']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <h6 for="kronologi" class="form-label">Detail Lokasi Kejadian</h6>
                                    <input type="text" class="form-control" id="alamat_kejadian" value="<?= $laporan['alamat_kejadian']; ?>" name="alamat_kejadian"
                                        required>
                                </div>
