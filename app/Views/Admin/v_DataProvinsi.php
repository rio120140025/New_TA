			...
			<div>
				...
				<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= site_url('dataprovinsi/' . $current_page); ?>">
			...
			<div class="body-wrapper radial-gradient min-vh-100">
				<div class="container-fluid">
					<div class="container-fluid">
						<div class="card">
							<div class="card-body">
								<form method="post" action="<?= route_to('dataprovinsi/' . $current_page); ?>">
									<div class="mb-3">
										<label for="search" class="form-label">Pencarian</label>
										<input type="text" class="form-control" name="search" id="search"
											aria-describedby="searchHelp">
										<div class="form-text">Masukkan kata kunci seperti nama provinsi</div>
									</div>
						...
						<div class="card">
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="post"
													action="<?= site_url('DataProvinsi/save_provinsi/' . $current_page); ?>">
													<div class="mb-3">
														<h6 for="prov_name" class="form-label"> Masukkan
															Nama Provinsi</h6>
														<input type="text" class="form-control" name="prov_name"
										...
										<tbody>
											...
											<?php foreach ($provinsi as $row): ?>
												<tr>
													...
													<td>
														<a href="<?= site_url('DataProvinsi/delete_provinsi/' . $current_page . '/' . $row->prov_id); ?>"
															class="text-danger">
							...
							<div class="pagination justify-content-center">
								<?php if ($total_data > 50): ?>
									...
									if ($current_page > 1) {
										echo '<a href="' . site_url("dataprovinsi/" . ($current_page - 1)) . '" class="btn btn-primary"><</a>';
									}

									for ($i = $start_page; $i <= $max_pages; $i++) {
										echo '<a href="' . site_url("dataprovinsi/" . $i) . '"';
										if ($i == $current_page) {
