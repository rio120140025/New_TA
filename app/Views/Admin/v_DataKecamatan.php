			...
			<div>
				...
				<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= site_url('datakecamatan/' . $current_page); ?>">
								<iconify-icon icon="tabler:location-filled"></iconify-icon>
			...
			<div class="body-wrapper radial-gradient min-vh-100">
				<div class="container-fluid">
					<div class="container-fluid">
						<div class="card">
							<div class="card-body">
								<form method="post" action="<?= route_to('datakecamatan/' . $current_page); ?>">
									<div class="mb-3">
						...
						<div class="card">
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="post"
													action="<?= site_url('DataKecamatan/save_kecamatan/' . $current_page); ?>">
													<div class="mb-3">
													...
													<div class="mb-3">
														<h6 for="dis_name" class="form-label">Masukkan Nama
															Kecamatan</h6>
														<input type="text" class="form-control" name="dis_name"
															id="dis_name" required>
													</div>
										...
										<tbody>
											...
											<?php foreach ($kecamatan as $row): ?>
												<tr>
													...
													<td>
														<a href="<?= site_url('DataKecamatan/delete_kecamatan/' . $current_page . '/' . $row->dis_id); ?>"
															class="text-danger">
							...
							<div class="pagination justify-content-center mb-4">
								<?php if ($total_data > 50): ?>
									...
									if ($current_page > 1) {
										echo '<a href="' . site_url("datakecamatan/" . ($current_page - 1)) . '" class="btn btn-primary"><</a>';
									}

									for ($i = $start_page; $i <= $max_pages; $i++) {
										echo '<a href="' . site_url("datakecamatan/" . $i) . '"';
										if ($i == $current_page) {
