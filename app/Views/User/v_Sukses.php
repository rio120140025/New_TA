                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="mb-3">
                                        <p class="form-label">Laporan anda telah diterima oleh pihak RESKRIM POLRES
                                            Lampung Utara.</p>
                                        ...
                                        <p class="form-label">Anda dapat melihat riwayat laporan pada website dan
                                            silahkan untuk melengkapi laporan anda!</p>
                                    </div>
                                </form>
                                <a href="<?= base_url('Dashboard'); ?>" class="btn btn-secondary">Back To
                                    Dashboard</a>
                            </div>
                        </div>
                    </div>
